...
object MessageLookup {
  ...
  object CaptureSaPostcode {
    ...
    val title = "The postcode used to register the trust for Self Assessment"
    val p1 = "The postcode you enter must match our records. For example, this postcode was used to register the trust for Self Assessment."
  ...
  object CaptureUaChrn {
    val title = "Association’s HMRC reference Number"
    val paragraph1 = "You can find your association’s HMRC reference number on the charity register (opens in new tab)."
    val paragraph2 = "If your association has registered for Gift Aid then the HMRC reference number will be the same as their Gift Aid number, it is not available on the charity register."
    val inset = "If you are registering as a ‘Charitable Incorporated Organisation’, you do not need to enter a UTR. Instead, click here the association does not have a UTR."
    ...
    val link = "the association does not have a UTR"
    val label = "What is your association’s HMRC reference number?"
