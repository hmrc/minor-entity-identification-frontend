...
trait MockValidateUnincorporatedAssociationDetailsConnector
  ...
  val mockValidateUnincorporatedAssociationDetailsConnector: ValidateUnincorporatedAssociationDetailsConnector =
    mock[ValidateUnincorporatedAssociationDetailsConnector]
